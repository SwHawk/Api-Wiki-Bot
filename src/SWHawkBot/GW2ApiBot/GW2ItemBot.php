...
class GW2ItemBot extends GW2ApiBot {
    ...
    public function __construct($version = parent::DFLT_VERSION, $lang = parent::DFLT_LANG) {
        ...
        $this->client_list = new Client(array('base_url' => $url.self::ITEMS_JSON));

        $this->client_details = new Client(array('base_url' => $url.self::ITEM_DETAILS_JSON));
    ...
    public function getItemRaw($id) {
        ...
        $request->getQuery()->set('item_id',$id)->set('lang',$this->lang);
